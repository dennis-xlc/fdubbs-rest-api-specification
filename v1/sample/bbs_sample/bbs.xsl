...
<xsl:template name='foot'>
	<div id='ft'><a href='#'>[<img src='../images/button/up.gif'/>回页首]</a>&#160;<xsl:value-of select='$bbsname'/> &#169;1996-2013 Powered by <a href='http://code.google.com/p/fbbs/'><strong>fbbs</strong></a></div>
</xsl:template>
